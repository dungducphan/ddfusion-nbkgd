...
MyPrimaryGenerator::MyPrimaryGenerator() {
  ...
  exDeuteriumIon->SetNumberOfParticles(1);
  ...
  exDeuteriumIon->GetPosDist()->SetCentreCoords(G4ThreeVector(0., 0., 10. * cm));
...
void MyPrimaryGenerator::GeneratePrimaries(G4Event* anEvent) {
  if (fGeneralParticleSource->GetCurrentSource()->GetParticleDefinition() == G4ParticleTable::GetParticleTable()->FindParticle("e-")) {
